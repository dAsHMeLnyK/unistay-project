...
const ListingForm = ({ 
    ...
    // ФУНКЦІЯ ДЛЯ ЗАБОРОНИ ВІДПРАВКИ ПО ENTER
    const handleKeyDown = (e) => {
        // Якщо натиснуто Enter і це НЕ опис (textarea)
    ...
    return (
        <form 
            onSubmit={onSubmit} 
            onKeyDown={handleKeyDown} // Додаємо цей обробник
        ...
        >
            <div className={styles.formColumns}>
                ...
                <div className={styles.formSection}>
                    ...
                    <div className={styles.formGroup}>
                        ...
                        <div className={styles.priceInputWrapper}>
                            <input 
                                className={`${styles.customInput} ${styles.priceInputCompact}`} 
                                type="number" 
                                name="price" 
                                value={formData.price} 
                                onChange={handleChange}
                                onWheel={(e) => e.target.blur()} // Заборона скролу ціни
                                required 
                                min="1"
                            />
                ...
                <div className={styles.formSection}>
                    ...
                    <div className={styles.formGroup}><label>Тип житла</label><Select name="type" value={formData.type} onChange={handleChange} options={LISTING_TYPES} /></div>
                    <div className={styles.formGroup}><label>Комунальні послуги</label><Select name="communalService" value={formData.communalService} onChange={handleChange} options={COMMUNAL_SERVICES} /></div>
                    <div className={styles.formGroup}><label>Проживання з господарями</label><Select name="owners" value={formData.owners} onChange={handleChange} options={OWNERSHIP_TYPES} /></div>
                    <div className={styles.formGroup}><label>Наявність сусідів</label><Select name="neighbours" value={formData.neighbours} onChange={handleChange} options={NEIGHBOUR_TYPES} /></div>
